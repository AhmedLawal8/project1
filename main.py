...
def create_itinerary(session, username, df, valid_airport_names, console):
  ...
  places = get_top_attractions(location_destination[0], location_destination[1], from_date_str, to_date_str)

  weather_origin = get_weather(from_date_str, from_date_str, location_origin[0], location_origin[1], origin)
  weather_destination = get_weather(from_date_str, to_date_str, location_destination[0], location_destination[1], destination)
  ...
  insert_itinerary(session, username, origin, destination, from_date_obj, to_date_obj, res)
